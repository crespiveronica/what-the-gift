...
indumentaria_natacion_mujer_3_product = Product.new(name: 'Short de mujer para natación', description: 'Short De Mujer Para Natacion Malla De Mujer Natacion - Anticloro', brand:'Swimming-Sym', approved: 'true', photo_url:'http://mla-s2-p.mlstatic.com/short-de-mujer-para-natacion-malla-de-mujer-natacion-7293-MLA5181478808_102013-O.jpg', "category_ids" => [indumentaria_natacion_mujer_category._id, ropa_category._id])
